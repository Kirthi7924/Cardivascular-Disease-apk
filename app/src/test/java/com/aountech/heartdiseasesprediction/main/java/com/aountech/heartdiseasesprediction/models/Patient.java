package com.aountech.heartdiseasesprediction.models;
...
public class Patient {
    ...
    public String restingBloodPressure;
    public String cholesterol;
    public String fastingBloodSugar;
    public String restEcg;
    public String maxHeartRate;
    public String exerciseInducedAngina;
    public String stDepression;
    public String stSlope;
    public String ca;
    public String thal;
